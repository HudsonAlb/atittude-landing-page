            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    >
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 flex flex-col gap-6">
                            <div className="flex items-start gap-4">
                                <div className="size-10 rounded-xl bg-[#ffcc00]/10 flex items-center justify-center shrink-0">
                                    <MapPin className="size-5 text-[#ffcc00]" />
                                </div>
                                <div>
                                    <h4 className="font-semibold text-white mb-1">Localização</h4>
                                    {/* TODO: substituir pelo endereço real da academia */}
                                    <p className="text-zinc-400 text-sm">Av. Atitude, 1000 - Centro, Recife - PE</p>
                                </div>
                            </div>

                            <div className="flex items-start gap-4">
                                <div className="size-10 rounded-xl bg-[#ffcc00]/10 flex items-center justify-center shrink-0">
                                    <Phone className="size-5 text-[#ffcc00]" />
                                </div>
                                <div>
                                    <h4 className="font-semibold text-white mb-1">WhatsApp</h4>
                                    <p className="text-zinc-400 text-sm">(81) 7305-2157</p>
                                </div>
                            </div>

                            <div className="flex items-start gap-4">
                                <div className="size-10 rounded-xl bg-[#ffcc00]/10 flex items-center justify-center shrink-0">
                                    <Clock className="size-5 text-[#ffcc00]" />
                                </div>
                                <div>
                                    <h4 className="font-semibold text-white mb-1">Horário</h4>
                                    <p className="text-zinc-400 text-sm">Seg - Sex: 05h às 23h</p>
                                    <p className="text-zinc-400 text-sm">Sábado: 08h às 18h</p>
                                </div>
                            </div>
                            ...
                            <div className="border-t border-zinc-800 pt-6 flex gap-3">
                                <a
                                    ...
                                    className="size-10 rounded-xl bg-zinc-800 hover:bg-[#ffcc00] hover:text-[#121212] text-zinc-400 flex items-center justify-center transition-all duration-200"
                    ...
                    <motion.form
                        ...
                        transition={{ duration: 0.6 }}
                        viewport={{ once: true }}
                        className="lg:col-span-3 bg-zinc-900 border border-zinc-800 rounded-2xl p-8 flex flex-col gap-4"
                    >
                        <Input
                            name="name"
                        ...
                        <Textarea
                            ...
                            onChange={handleChange}
                            required
                            className="bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500 focus-visible:ring-[#ffcc00] focus-visible:border-[#ffcc00] min-h-[120px] resize-none"
                        />
                        <Button
                            type="submit"
                            disabled={submitted}
                            className="w-full h-12 bg-[#ffcc00] text-[#121212] hover:bg-[#e6b800] font-bold uppercase tracking-widest text-base shadow-[0_0_20px_rgba(255,204,0,0.25)] mt-2"
                        >
